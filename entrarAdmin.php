...
<ul class="menu_main">
  <li> <a href="#"> ||| </a>
    <ul class="sub_menu">
      <hr>
      <li><a href="registrarUsuarios.php"> Crear Usuario </a></li>
      <hr>
    ...
    <li>  
        <label class="textoTitulo"> HANDBALL MANAGER </label> 
    </li>
    <li>
         <label class="textoUsuario"> Usuario: <?php echo $nombreUsuario; ?> </label>
    </li>
  </li>
</ul>
</nav>
